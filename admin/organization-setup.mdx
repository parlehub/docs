...
<Steps>
  ...
  <Step title="Connect Model Providers">
    Navigate to **Settings → Model Providers** and add the AI providers your firm will use (for example, OpenAI, Anthropic, or Azure Foundry). Provider credentials are stored at the org level and made available to all projects. See the [Connecting Providers](/models/connecting-providers) guide for step-by-step instructions.
  </Step>
