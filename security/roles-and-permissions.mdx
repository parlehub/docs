...
| **Project Admin** | Per-project | Create and delete conversations; manage project members; set the project expense code; **view** the project's caps, budget currency, reporting currency and spend (read-only); request a higher limit |
